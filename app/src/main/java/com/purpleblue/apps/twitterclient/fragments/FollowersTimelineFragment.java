 ...
 */
public class FollowersTimelineFragment extends UsersListFragment {

    private TwitterClient client;

    public static FollowersTimelineFragment newInstance (String screenName) {
        FollowersTimelineFragment followersTimelineFragment = new FollowersTimelineFragment();

        Bundle args = new Bundle();
        args.putString("screen_name", screenName);
        followersTimelineFragment.setArguments(args);

        return followersTimelineFragment;
    }
    ...
    public void populateTimeline(String screenName) throws JSONException {
        client.getFollowersList(screenName, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject json) {
                Log.d(String.format("%s getFollowersList", Constants.DEBUG_KEY), json.toString());
