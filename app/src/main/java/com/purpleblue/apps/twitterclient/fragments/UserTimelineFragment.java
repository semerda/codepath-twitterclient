...
public class UserTimelineFragment extends TweetsListFragment {
    ...
    // UserTimelineFragment.newInstance("ernestsemerda");
    ...
    public void populateTimeline() throws JSONException {
        ...
        if (Constants.SCAFFOLD_DATA) {
            ...
            client.getUserTimeline(screenName, new JsonHttpResponseHandler() {
                ...
                public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                    Log.d(String.format("%s error2", Constants.DEBUG_KEY), throwable.toString());
                }

                @Override
                public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONArray errorResponse) {
                    Log.d(String.format("%s error3", Constants.DEBUG_KEY), errorResponse.toString());
                }
            });
        }
    }
